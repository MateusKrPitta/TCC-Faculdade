...
class CreateClientesTable extends Migration {
    ...
    public function up() {
        Schema::create('clientes', function (Blueprint $table) {
            ...
            $table->string('cpfcnpj')->nullable()->comment('Numero da inscrição CNPJ ou CPF');
            $table->string('rgie')->nullable()->comment('Numero da inscrição estadual ou RG');
            $table->date('nascimento')->nullable()->comment('Data de Nascimento do Cliente ou data de abertura da Razão Social');
