...
class CreateVeiculoscarroceriaTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('veiculoscarroceria', function (Blueprint $table) {
            $table->increments('id');
            $table->index('id');
            $table->unsignedInteger('empresa_id')->comment('ID da empresa multi-empresa');
            $table->foreign('empresa_id')->references('id')->on('empresas')->onDelete('cascade');
            
            $table->string('carroceria')->comment('Nome do tipo de carroceria');
    ...
    public function down() {
        Schema::dropIfExists('veiculoscarroceria');
    }
