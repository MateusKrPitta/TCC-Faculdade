...
class CreateVeiculospropriedadeTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('veiculospropriedade', function (Blueprint $table) {
            $table->increments('id');
            $table->index('id');
            $table->unsignedInteger('empresa_id')->comment('ID da empresa multi-empresa');
            $table->foreign('empresa_id')->references('id')->on('empresas')->onDelete('cascade');
            
            $table->string('propriedade')->comment('Nome do tipo de propriedade');
    ...
    public function down() {
        Schema::dropIfExists('veiculospropriedade');
    }
