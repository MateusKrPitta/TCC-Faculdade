...
class CreateConveniotipodeatendimentosTable extends Migration {
     ...
     */
    public function up() {
        Schema::create('conveniotipodeatendimentos', function (Blueprint $table) {
            $table->increments('id');
            $table->index('id');
            $table->unsignedInteger('empresa_id')->comment('ID da empresa multi-empresa');
            $table->foreign('empresa_id')->references('id')->on('empresas')->onDelete('cascade');

            $table->string('nome')->comment('Nome do tipo de atendimento');
    ...
    public function down() {
        Schema::dropIfExists('conveniotipodeatendimentos');
    }
