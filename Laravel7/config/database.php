...
return [
    ...
    'default' => env('DB_CONNECTION', 'basesistema'),
    /*
      |--------------------------------------------------------------------------
    ...
    'connections' => [
        ...
        'casadalavoura' => [
            'driver' => 'firebird',
            'host' => env('DB_FIREBIRD_HOST', '192.168.100.8'),
            'database' => env('DB_FIREBIRD_DATABASE', '/siagri/CASALAVOURA.FDB'),
        ...
        'cooperbrasil' => [
            ...
            'database' => env('DB_FIREBIRD_DATABASE', 'C:\Gerencial FB\GERENCIAL-13-03-2022.FDB'),
            'username' => env('DB_FIREBIRD_USERNAME', 'SYSDBA'),
            'password' => env('DB_FIREBIRD_PASSWORD', 'masterkey'),
