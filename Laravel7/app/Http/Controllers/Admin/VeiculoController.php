...
use App\Http\Requests\VeiculoRequest; //Adicionado por Cezar
...
class VeiculoController extends Controller {
    ...
    public function veiculo1() {
        return view('admin.veiculo.veiculo1');
    }

    public function veiculo2() {
        return view('admin.veiculo.veiculo2');
    }

    public function veiculo3() {
        return view('admin.veiculo.veiculo3');
    }
    ...
    public function cadastrar() {
        ...
        $clientes = DB::table('clientes')
                ...
                ->orderBy('nome')
                ->get();
        return view('admin.veiculo.cadastrar')
                        ->with('cores', $cores)
                        ->with('marcas', $marcas)
    ...
    public function gravar(VeiculoRequest $request) {
        $dados = Request::all();
        ...
        return redirect('/veiculo/cadastrar')->withInput();
    }
    ...
    public function editar() {
        ...
        $clientes = DB::table('clientes')
                ...
                ->orderBy('nome')
                ->get();
        return view('admin.veiculo.editar')
                        ->with('cores', $cores)
                        ->with('marcas', $marcas)
                        ->with('especies', $especies)
                        ->with('categorias', $categorias)
    ...
    public function atualizar(VeiculoRequest $request) {
        ...
        $veiculo->save();
        return redirect('/veiculo/listar')->withInput(); //redireciona por url
    }
    ...
    public function listar() {
        ...
        return view('admin.veiculo.listar', compact('veiculos', 'cabecalho', 'config'));
    }
