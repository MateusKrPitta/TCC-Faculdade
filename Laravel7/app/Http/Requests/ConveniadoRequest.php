...
class ConveniadoRequest extends FormRequest {
    ...
    public function rules() {
        return [
            'nome' => ['required', Rule::unique('conveniados')->ignore($this->id), 'min:2', 'max:256'],
            'cpfcnpj' => ['numeric', 'required', Rule::unique('conveniados')->ignore($this->id), 'cpf_cnpj'],
            'rgie' => ['nullable', Rule::unique('conveniados')->ignore($this->id)],
