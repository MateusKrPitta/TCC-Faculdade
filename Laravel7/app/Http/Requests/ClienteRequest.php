...
class ClienteRequest extends FormRequest {
    ...
    public function rules() {
        return [
            ...
            'cpfcnpj' => ['nullable', 'numeric', Rule::unique('clientes')->ignore($this->id), 'cpf_cnpj'],
            'rgie' => ['nullable', Rule::unique('clientes')->ignore($this->id)],
            'razaosocial' => ['nullable', Rule::unique('clientes')->ignore($this->id)],
    ...
    public function messages() {
        return [
            ...
            'razaosocial.unique' => 'RG já está em uso.',
