...
class Exame extends Model
{
    ...
    protected $table = 'exames'; // Nome da Tabela no banco de dados
    public $timestamps = true;  //Atualiza os campos de ultima atualização e data da gravação
    protected $fillable = array('empresa_id', 'nome', 'valor', 'valor_referencia', 'descricao', 'tempo', 'status', 'usuario_id'); //Informações que serão gravadas no banco
