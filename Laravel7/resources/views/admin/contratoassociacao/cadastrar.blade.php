...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarContratoassociacao' id='FormularioCadastrarContratoassociacao' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >
        <fieldset title='Informações do Contrato' name='blocoform01' id='blocoform01'><legend>Informações do Contrato</legend>
            <input type="hidden" name="acao" id="acao" value="Contratoassociacaonovogravar" />
