...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarContratoconvenio' id='FormularioCadastrarContratoconvenio' action="/contratoconvenio/gravar" enctype="application/x-www-form-urlencoded" method="post" >
        ...
        <fieldset title='Informações do Contrato' name='blocoform01' id='blocoform01'><legend>Informações do Contrato</legend>
            ...
            <input type="hidden" name="conveniado" value="1" />
