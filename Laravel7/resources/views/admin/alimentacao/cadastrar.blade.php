...
<div class=" col-lg-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarAlimento' id='FormularioCadastrarAlimentocao' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >
        ...
        <div>
           ...
           <div class="form-row">
                <div class="col-md-3 mb-2">
                    ...
                    <x-adminlte-input class='form-control' name='peso' type='numer' size='10' title='Informe o peso' value="{{ $errors->all() ? old('peso') : '' }}"/>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-3 mb-2">
                    ...
                    <x-adminlte-input class='form-control' name='dataalimentacao' id='datafim' type='date' size='10' title='Informe a data de alimentação' value="{{ $errors->all() ? old('dataalimentacao') : '' }}"/>
                </div>
            </div>
            <br />
