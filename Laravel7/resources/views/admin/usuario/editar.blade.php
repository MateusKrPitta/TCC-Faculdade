        ...
        <fieldset title='Informações do Usuário' name='blocoform01' id='blocoform01'><legend>Informações do Usuário</legend>
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    ...
                    <input type="hidden" name="senhaantiga" value="{{ $usuario->password }}" />
                    <x-adminlte-input class="form-control" name='password' type='password' size='50' title='Coloque a senha do Usuário' value="{{ $usuario->password }}"/>
                    <div class="valid-feedback">Certo!</div>
                </div>
            </div>
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    ...
                    <x-adminlte-select2 class="form-control" name="empresa_id" title='Escolha a empresa'>
                        ...
                        <option value="{{$empresa->id}}" {{ $usuario->empresa_id == $empresa->id ? 'selected' : '' }}>{{$empresa->nome}}</option>
                        @empty
                        @endforelse
                    </x-adminlte-select2>
                </div>
