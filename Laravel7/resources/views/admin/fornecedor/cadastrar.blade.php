...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarFornecedor' id='FormularioCadastrarFornecedor' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >

        <fieldset title='Informações do Fornecedor' name='blocoform01' id='blocoform01'><legend>Informações do Fornecedor</legend>

            <x-adminlte-input type="hidden" name="acao" id="acao" value="Fornecedornovogravar" />
            <x-adminlte-input type="hidden" name="_token" value=" {{ csrf_token() }} " />
            <x-adminlte-input type="hidden" name="status" id="status" value="1" />

            <div class="form-row">
                <div class="col-md-6 mb-3">
                    <label class="" for='nome'>Nome ou Nome Fantasia</label>

                    <x-adminlte-input class="form-control" name='nome' type='text' title='Coloque o nome do Fornecedor ou Nome Fantasia da Empresa' value="{{ $errors->all() ? old('nome') : '' }}" />
            ...
            <div class="form-row">
                <div class="col-md-3 mb-3">
                    ...
                    <x-adminlte-input class="form-control" name='nascimento' type='date' title='Informe a data do nascimento do Fornecedor ou a data de abertura da Empresa' value="{{ $errors->all() ? old('nascimento') : '' }}" />
                    <div class="valid-feedback">Certo!</div>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="col-md-1 mb-3">
                    ...
                    <x-adminlte-input class="form-control" name='estado' type='text' size="2"  title='Informe a sigla do Estado' value="{{ $errors->all() ? old('estado') : 'MS' }}" />
                    <div class="valid-feedback">Certo!</div>
                </div>             
