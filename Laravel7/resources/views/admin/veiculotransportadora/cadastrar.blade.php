            ...
            <div class="form-row">
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <x-adminlte-select2 class="form-control" name="desenho" title='Escolha o layout do veículo'>
                        ...
                        <option value="veiculo3" {{ $errors->all() & (old('desenho') == "veiculo3") ? ' selected' : '' }}>LD Leito 28 Poltronas</option>
                        <option value="veiculo4" {{ $errors->all() & (old('desenho') == "veiculo4") ? ' selected' : '' }}>LD Semi-Leito 36 Poltronas</option>
                        <option value="veiculo5" {{ $errors->all() & (old('desenho') == "veiculo5") ? ' selected' : '' }}>Toquinho 18 Poltronas</option>
                    </x-adminlte-select2>
                    <div class="valid-feedback">Certo!</div>
                </div>
                <div class="col-md-3 mb-2">
