...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='formulariocontasareceber' id='formulariocontasareceber' action="/contasareceber/gravar" enctype="application/x-www-form-urlencoded" method="post" >
            ...
            <fieldset title='Informações da Conta a Receber' name='blocoform01' id='blocoform01'><legend>Informações da Conta a Receber</legend>
                ...
                <div class="form-row">
                    <div  class="col-md-6 mb-6">
                        ...
                        <x-adminlte-select2 class="form-control" name="cliente_id" id='idcliente' title='Escolha o Cliente'> 
