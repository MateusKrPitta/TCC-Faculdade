...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarInseminacao' id='FormularioCadastrarInseminacao' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >

        <div>
            <fieldset title='Informações da Inseminação' name='blocoform01' id='blocoform01'><legend>Informações da Inseminação</legend>
                <input type="hidden" name="acao" id="acao" value="Inseminacaonovogravar" />
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-4">
                        ...
                        <x-adminlte-select2 name="animal_id" class="form-control">
                            ...
                            <option value="{{ $animal->animal_id }}">{{ $animal->animal_nome }}</option>
                            @empty
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <x-adminlte-input class="form-control" name='datainseminacao' type='date' size='50' title='Informe a data do nascimento do Inseminacao' value="{{ $errors->all() ? old('datainseminacao') : '' }}"/>
                    </div>
                    <div class="col-md-4 mb-4">
                ...
                <div class="form-row">
                    <div class="col-md-4 mb-4">
                        ...
                        <x-adminlte-input class="form-control" name='touro' type='text' size='50' title='Coloque o nome do Touro' value="{{ $errors->all() ? old('touro') : '' }}"/>
                    </div>

                    <div class="col-md-4 mb-4">
                        <label class="" for='inseminador'>Nome do Inseminador</label>
                        <x-adminlte-input class="form-control" name='inseminador' type='text' size='50' title='Coloque o nome do Inseminador' value="{{ $errors->all() ? old('inseminador') : '' }}"/>
                    </div>
                </div>
                <div class="form-row">
