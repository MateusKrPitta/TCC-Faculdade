...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarProducao' id='FormularioCadastrarProducao' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >
            ...
            <fieldset title='Informações da Produção' name='blocoform01' id='blocoform01'><legend>Informações da Produção</legend>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <x-adminlte-input class="form-control" name='data_producao' type='date' size='50' title='Informe a data da Producao' value="{{ $errors->all() ? old('data_producao') : '' }}"/>
                    </div>
                    <div class="col-md-2 mb-4">
                    ...
                    <div class="col-md-2 mb-4">
                        ...
                        <x-adminlte-input class="form-control" name='quantidade' type='text' size='50' title='Coloque a quantidade de leite produzido' value="{{ $errors->all() ? old('quantidade') : '' }}"/>
                    </div>
                </div>
        </div>
