...
<div class=" col-sm-12">
    <!--Formulario-->
    <form class="needs-validation" name='FormularioCadastrarFormadepagamento' id='FormularioCadastrarFormadepagamento' action="gravar" enctype="application/x-www-form-urlencoded" method="post" >
        ...
        <fieldset title='Informações do Formadepagamento' name='blocoform01' id='blocoform01'><legend>Informações do Formadepagamento</legend>
            ...
            <input type="hidden" name="acao" id="acao" value="Formadepagamentonovogravar" />
